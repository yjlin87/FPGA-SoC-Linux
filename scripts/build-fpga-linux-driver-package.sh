...
git archive --remote fpgacfg   --prefix=fpgacfg/  --format=tar v0.0.2 | tar xf - -C drivers
git archive --remote fclkcfg   --prefix=fclkcfg/  --format=tar v0.0.1 | tar xf - -C drivers
git archive --remote udmabuf   --prefix=udmabuf/  --format=tar v0.8.0 | tar xf - -C drivers
